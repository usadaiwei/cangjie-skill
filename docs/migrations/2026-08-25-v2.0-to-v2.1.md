...
python3 scripts/cangjie.py compile --bundle books/<book>/.cangjie/capabilities --out dist/<book> --output auto
```
...
python3 scripts/cangjie.py update --pack books/<book> --add <new-edition.md>
